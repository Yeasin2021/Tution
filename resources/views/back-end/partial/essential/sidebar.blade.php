<nav class="sidebar">
    <div class="logo d-flex justify-content-between">
        <a class="large_logo" href="index-2.html"><img src="{{ asset('back-end') }}/img/logo.png" alt="" /></a>
        <a class="small_logo" href="index-2.html"><img src="{{ asset('back-end') }}/img/mini_logo.png" alt="" /></a>
    ...
    <ul id="sidebar_menu">
        <li>
            <a href="index-2.html" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/dashboard.svg" alt="" />
                </div>
                <div class="nav_title">
                    <span>Analytic</span>
                </div>
        ...
        <li>
            <a href="index_2.html" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/2.svg" alt="" />
                </div>
                <div class="nav_title">
                    <span>Default </span>
                </div>
        ...
        <li>
            <a href="index_3.html" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/3.svg" alt="" />
                </div>
                <div class="nav_title">
                    <span>Dark </span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/5.svg" alt="" />
                </div>
                <div class="nav_title">
        ...
        <li class="">
            ...
            <ul>
                ...
                <li><a href="{{ route('routineTable') }}">Routine Table</a></li>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/4.svg" alt="" />
                </div>
                <div class="nav_title">
                    <span>Themes</span>
                </div>
        ...
        <li class="">
            <a href="invoice.html" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/6.svg" alt="" />
                </div>
                <div class="nav_title">
                    <span>Invoice</span>
                </div>
        ...
        <li class="">
            <a href="calender.html" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/7.svg" alt="" />
                </div>
                <div class="nav_title">
                    <span>Calander</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/8.svg" alt="" />
                </div>
                <div class="nav_title">
                    <span>Products</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/9.svg" alt="" />
                </div>
                <div class="nav_title">
                    <span>Icons</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/11.svg" alt="" />
                </div>
                <div class="nav_title">
                    <span>Table</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/12.svg" alt="" />
                </div>
                <div class="nav_title">
                    <span>Cards</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/14.svg" alt="" />
                </div>
                <div class="nav_title">
                    <span>Widgets</span>
                </div>
        ...
        <li class="">
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="nav_icon_small">
                    <img src="{{ asset('back-end') }}/img/menu-icon/15.svg" alt="" />
                </div>
                <div class="nav_title">
            ...
            <ul>
                <li><a href="{{ route('update-password.reset.form') }}">Reset Password</a></li>
                {{-- <li><a href="vector_map.html">Vector Maps</a></li> --}}
            </ul>
            <ul>
                <li><a href="{{ route('mail-host-form') }}">Mail Setting</a></li>
