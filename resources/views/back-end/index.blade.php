...
<html lang="zxx">
	...
	<body class="crm_body_bg" onload="showPosition(); getWeather();">
						...
						<li>
							<a href="#">
								<div class="member_thumb">
									<img src="{{ asset('back-end') }}/img/staf/1.png" alt="" />
								</div>
							</a>
						</li>
						<li>
							<a href="#">
								<div class="member_thumb">
									<img src="{{ asset('back-end') }}/img/staf/2.png" alt="" />
								</div>
							</a>
						</li>
						<li>
							<a href="#">
								<div class="member_thumb">
									<img src="{{ asset('back-end') }}/img/staf/3.png" alt="" />
								</div>
							</a>
						</li>
						<li>
							<a href="#">
								<div class="member_thumb">
									<img src="{{ asset('back-end') }}/img/staf/4.png" alt="" />
								</div>
							</a>
						</li>
						<li>
							<a href="#">
								<div class="member_thumb">
									<img src="{{ asset('back-end') }}/img/staf/5.png" alt="" />
								</div>
							</a>
						</li>
						<li>
		...
		{{-- {{ asset('back-end') }}/js/iziToast.min.js --}}

        {{-- Google Map Location Api & Code End Here --}}
	</body>
